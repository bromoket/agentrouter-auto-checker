...
function createTestConfig(
  ...
  return {
    ...
    browserExecutable: process.platform === "win32" ? "C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe" : "/usr/bin/google-chrome-stable",
    browserWorkerCdpPort: 19_222,
    browserPollerCdpPort: 19_223,
    browserStartTimeoutMs: 30_000,
    browserPollerProfileDir: join(dataDir, "poller-profile"),
